...
class ApiRoutesMixin:
    ...
    def do_GET(self) -> None:
        try:
            ...
            if len(parts) == 6 and parts[0] == "admin" and parts[1] == "movies" and parts[2] == "scrape" and parts[3] == "bulk" and parts[4] == "items":
                self._handle_admin_movie_scrape_bulk_items(
                    parts[5],
    ...
    def do_POST(self) -> None:
        try:
            ...
            if len(parts) == 3 and parts[0] == "admin" and parts[1] == "automation" and parts[2] == "idle-game-exit":
                ...
                return
            if len(parts) == 3 and parts[0] == "admin" and parts[1] == "automation" and parts[2] == "wifi-recovery":
                payload = self._read_json_body()
            ...
            if len(parts) == 4 and parts[0] == "admin" and parts[1] == "torrents" and parts[3] == "remove":
                self._handle_admin_torrent_remove(parts[2])
                return

            if len(parts) == 4 and parts[0] == "admin" and parts[1] == "torrents" and parts[3] == "adopt":
                self._handle_admin_torrent_adopt(parts[2])
                return
            ...
            if len(parts) == 5 and parts[0] == "admin" and parts[1] == "movies" and parts[2] == "scrape" and parts[3] == "bulk" and parts[4] == "stop":
                self._handle_admin_movie_scrape_bulk_stop()
                return
            ...
            if len(parts) == 5 and parts[0] == "admin" and parts[1] == "music" and parts[2] == "scrape" and parts[3] == "bulk" and parts[4] == "stop":
                self._handle_admin_music_scrape_bulk_stop()
                return
