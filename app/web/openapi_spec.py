...
def _schemas() -> Dict[str, Schema]:
    ...
    return {
        ...
        "IdleVolumeConfig": _object({"enabled": _boolean(), "idle_seconds": _integer(), "target_volume": _integer(), "restore_on_input": _boolean(), "armed": _boolean()}),
        ...
        "AutomationStatusResponse": _object({"idle_volume": _ref("IdleVolumeConfig"), "input_monitor": _ref("InputMonitorStatus"), "current_volume": _integer(nullable=True)}, ("idle_volume", "input_monitor", "current_volume")),
        "IdleVolumeUpdateRequest": _object({"enabled": _boolean(), "idle_seconds": _integer(), "target_volume": _integer(), "restore_on_input": _boolean()}),
